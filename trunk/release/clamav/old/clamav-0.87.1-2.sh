...
fixup() {
  ...
  alternatives --set libtool  /usr/bin/libtool-1.9
  ...
  (cd ${srcdir}
    ...
    cp /usr/share/libtool/ltmain.sh ${srcdir}/
    # cp /usr/autotool/devel/share/libtool/ltmain.sh ${srcdir}/
...
build() {
  (cd ${objdir}
  #LDFLAGS="-Wl,--enable-auto-image-base -Wl,--enable-runtime-pseudo-reloc ${MY_LDFLAGS}" 
